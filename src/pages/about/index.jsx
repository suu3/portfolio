      ...
      <section className={`${styles[`about`]} section`}>
        ...
        <article className={styles[`article`]} data-aos="fade-up">
          ...
          <p>
            ...
            때문입니다. <br />
            저는 공모전이나 개발 챌린지, 프로젝트 고도화 프로그램, 튜터링
            프로그램 등에 참여하기도 하며 매일 도전하고 경험하며 살고 있습니다.
            이런 도전을 통해 저는 나날이 성장합니다.
          </p>
          <p>
            <strong>협업을 좋아하는 개발자이기도 합니다. </strong>
            <br />팀 프로젝트의 장점은 혼자서는 발견할 수 없었던 문제들을 해결할
            수 있다는 것과 단기간에 멋진 결과물을 내는 힘이라고 생각합니다.{" "}
            <br />
            저는 이런 팀 프로젝트의 장점에 매력을 느끼고 장단기에 걸친 다양한 팀
            프로젝트를 진행하면서 팀원 간의 소통 방법을 익혀왔습니다.
          </p>
        </article>
        {/* <SubTitle id="education" content="학력" />
        <TimeLine /> */}
